...
public class PangolinPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToActivity(ActivityPluginBinding binding) {
        ...
        initTTSDKConfig();
        flutterPluginBinding.getPlatformViewRegistry().registerViewFactory("com.tongyangsheng.pangolin_info_view", new InfoViewFactory(flutterPluginBinding.getBinaryMessenger(), activity, mTTAdNative));
    }
